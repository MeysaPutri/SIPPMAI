...
Route::middleware(['sudah_login'])->group(function () {
    ...
    Route::get('/scm/persetujuan', 'SCMController@persetujuan')->name('persetujuan.scm');
    Route::get('/scm/{id}/edit', 'SCMController@edit')->name('edit.scm');
    Route::patch('/scm/{id}', 'SCMController@update')->name('update.scm');
