              ...
              <table class="table table-striped" >
                <thead>
                  <tr>
                    ...
                    <th scope="col">Target Minimum</th>
                ...
                <input type="hidden" name="id_aktifitas[]" id="" value="{{$isi->id_aktifitas}}">
                  <tr>
                    ...
                    <td>                  
                      ...
                      @elseif($isi->nama_aktifitas == 'Tilawah quran')
                        <input type="number" min="0" max="154" name="isian[]"  id="" class="form-control" {{session('id_role') == 1 ? 'readonly' : ''}} {{session('id_role') == 4 ? 'readonly' : ''}} required="">
                      @elseif($isi->nama_aktifitas == 'Hafalan juz 30')
                      ...
                      @elseif($isi->nama_aktifitas == 'Wirid matsurat')
                        <input type="number" min="0" max="14" name="isian[]"  id="" class="form-control" {{session('id_role') == 1 ? 'readonly' : ''}} {{session('id_role') == 4 ? 'readonly' : ''}} required="">
                      @elseif($isi->nama_aktifitas == 'Shalat dhuha')
                        <input type="number" min="0" max="7" name="isian[]"  id="" class="form-control" {{session('id_role') == 1 ? 'readonly' : ''}} {{session('id_role') == 4 ? 'readonly' : ''}} required="">
                      @elseif($isi->nama_aktifitas == 'Shalat berjamaah di masjid')
          ...
          <table class="table table-striped">
            ...
            <input type="hidden" name="id_aktifitas[]" id="" value="{{$isi->id_aktifitas}}">
              <tr>
                ...
                @elseif($isi->nama_aktifitas == 'Tilawah quran')
                  <input type="number" min="0" max="154"  name="isian[]"  id="isian[]" class="form-control" value="@if ($amalan[$key]->id_aktifitas==3){{$amalan[$key]->isian}}
                  @endif" {{session('id_role') == 1 ? 'readonly' : ''}} {{session('id_role') == 4 ? 'readonly' : ''}} required="">
                  <script>
                    document.getElementsByName('isian[]')[2].value ="{{ $amalan[2]->isian }}"
                  </script> 
                @elseif($isi->nama_aktifitas == 'Hafalan juz 30')
                  <input type="number" min="0" max="7"  name="isian[]"  id="isian[]" class="form-control" value="@if ($amalan[$key]->id_aktifitas==4){{$amalan[$key]->isian}}
                  @endif" {{session('id_role') == 1 ? 'readonly' : ''}} {{session('id_role') == 4 ? 'readonly' : ''}} required="">
                  <script>
                    document.getElementsByName('isian[]')[3].value ="{{ $amalan[3]->isian }}"
                  </script> 
                @elseif($isi->nama_aktifitas == 'Wirid matsurat')
                  <input type="number" min="0" max="14"  name="isian[]"  id="isian[]" class="form-control" value="@if ($amalan[$key]->id_aktifitas==5){{$amalan[$key]->isian}}
                  @endif" {{session('id_role') == 1 ? 'readonly' : ''}} {{session('id_role') == 4 ? 'readonly' : ''}} required="">
                  <script>
                ...
                @elseif($isi->nama_aktifitas == 'Membaca buku islami')
                  <input type="number" min="0" max="1"  name="isian[]"  id="isian[]" class="form-control" value="@if ($amalan[$key]->id_aktifitas==8){{$amalan[$key]->isian}}
                  @endif" {{session('id_role') == 1 ? 'readonly' : ''}} {{session('id_role') == 4 ? 'readonly' : ''}} required="">
                  <script>
                ...
                @elseif($isi->nama_aktifitas == 'Agenda ukhwah')
                  <input type="number" min="0" max="1"  name="isian[]"  id="isian[]" class="form-control" value="@if ($amalan[$key]->id_aktifitas==11){{$amalan[$key]->isian}}
                  @endif" {{session('id_role') == 1 ? 'readonly' : ''}} {{session('id_role') == 4 ? 'readonly' : ''}} required="">
                  <script>
                    document.getElementsByName('isian[]')[10].value ="{{ $amalan[10]->isian }}"
                  </script> 
                @elseif($isi->nama_aktifitas == 'Sholat rawatib')
                  <input type="number" min="0" max="1"  name="isian[]"  id="isian[]" class="form-control" value="@if ($amalan[$key]->id_aktifitas==12){{$amalan[$key]->isian}}
                  @endif" {{session('id_role') == 1 ? 'readonly' : ''}} {{session('id_role') == 4 ? 'readonly' : ''}} required="">
                  <script>
